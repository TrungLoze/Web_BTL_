...
const Enrollment = require('../../models/ac2070/Enrollment');
const fs = require('fs');
...
const courseController = {
    ...
    async getCourseList(req, res) {
        try {
            ...
            res.render('ac2070/courses/course_list', {
                courses: courses
            });
        } catch (error) {
            console.error(error);
    ...
    async getDashboard(req, res) {
        try {
            ...
            res.render('ac2070/courses/course_dashboard', { courses });
        } catch (error) {
            console.error(error);
            res.redirect('/ac2070');
        }
    ...
    async getCourseDetail(req, res) {
        try {
            ...
            res.render('ac2070/courses/course_detail', { 
                course: course,
                lessons: lessons,
    ...
    getCreateCourse(req, res) {
        res.render('ac2070/courses/course_create', { error: null });
    },
    ...
    async postCreateCourse(req, res) {
        try {
            ...
            console.error(error);
            res.render('ac2070/courses/course_create', { error: 'Đã có lỗi xảy ra khi tạo khóa học.' });
        }
    },
    ...
    async getEditCourse(req, res) {
        try {
            ...
            res.render('ac2070/courses/course_edit', { course, error: null });
        } catch (error) {
            console.error(error);
    ...
    async postEditCourse(req, res) {
        ...
        try {
            ...
            console.error(error);
            const course = await Course.getBySlug(slug);
            res.render('ac2070/courses/course_edit', { course, error: 'Đã có lỗi xảy ra khi cập nhật khóa học.' });
        }
    },
    ...
    async getRebin(req, res) {
        try {
            ...
            res.render('ac2070/courses/course_rebin', { courses });
        } catch (error) {
            console.error(error);
            res.redirect('/ac2070/course/dashboard');
        }
